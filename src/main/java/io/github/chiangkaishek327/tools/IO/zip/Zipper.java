package io.github.chiangkaishek327.tools.IO.zip;
...
import io.github.chiangkaishek327.tools.observable.ObservableMap;
import io.github.chiangkaishek327.tools.observable.ObservableValue;
...
public class Zipper<K> {
    ...
    public abstract class ZipperTask implements Closeable {
         ...
         * 
         * @return its progress
         *         {@link io.github.chiangkaishek327.tools.observable.ObservableValue}
         */
